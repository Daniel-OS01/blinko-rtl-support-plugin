...
## 2024-05-19 - Optimize matches() calls inside MutationObserver
**Learning:** Checking `element.matches(selector)` in a loop over multiple CSS selectors inside a `MutationObserver` callback causes significant CPU overhead.
