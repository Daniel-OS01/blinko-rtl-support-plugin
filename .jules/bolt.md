...
## 2026-05-30 - Optimize NodeList Iteration
**Learning:** Iterating over NodeList objects directly via for...of is significantly faster than Array.from(), avoiding memory allocation overhead (~70% reduction).
**Action:** Use direct for...of loops for querySelectorAll results instead of converting to Arrays.
