...
## 2026-06-03 - Optimize NodeList Iteration
**Learning:** Iterating over `NodeList` objects directly via `for...of` is significantly faster than converting them to an array with `Array.from()`. This avoids memory allocations and reduces iteration overhead.
