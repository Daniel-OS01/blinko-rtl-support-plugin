...
.rtl-debug-ltr::after {
  ...
  private setupObserver() {
      ...
      // ⚡ Bolt: Cache configuration-dependent calculations outside the observer callback.
      // Computing active selectors and safe matching lists via `document.querySelector`
      // on every mutation leads to severe performance degradation.
