  ...
  private applyBackButton(): void {
    ...
    const runBackButtonHandler = (_e: PopStateEvent) => {
      ...
      const findVisibleOverlay = (): HTMLElement | null => {
        ...
        // 💡 What: Replaced Array.from(NodeList) with direct for...of loop over NodeList.
        // 🎯 Why: Iterating directly over NodeList avoids allocating an array and the iteration overhead, leading to faster execution.
      ...
      if (overlay) {
        ...
        // 💡 What: Replaced Array.from(NodeList).find with direct for...of loop and break.
        // 🎯 Why: Iterating directly over NodeList avoids allocating an array.
