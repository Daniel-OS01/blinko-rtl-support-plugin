  ...
  private applyBackButton(): void {
    ...
    const runBackButtonHandler = (_e: PopStateEvent) => {
      ...
      const findVisibleOverlay = (): HTMLElement | null => {
        ...
        // ⚡ Bolt Performance: Iterating directly over NodeList avoids intermediate Array allocation (Array.from)
      ...
      if (overlay) {
        ...
        // ⚡ Bolt Performance: Using for...of instead of Array.from().find() avoids creating a temporary array
