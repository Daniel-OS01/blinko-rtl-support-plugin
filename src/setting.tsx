        ...
        <div style={{ marginBottom: '15px', padding: '15px', background: settings.darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(0,0,0,0.03)', borderRadius: '6px' }}>
          ...
          <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap', alignItems: 'center' }}>
            ...
            <button
              ...
              title={!settings.enabled ? "Enable dynamic settings first" : !selectedPresetId ? "Select a preset to load" : "Load preset"}
              style={{
                background: '#17a2b8',
                color: 'white',
                border: 'none',
            ...
            <button
              ...
              title={!settings.enabled ? "Enable dynamic settings first" : BUILT_IN_PRESETS.some(p => p.id === selectedPresetId) ? "Built-in presets cannot be deleted" : !selectedPresetId ? "Select a preset to delete" : "Delete selected preset"}
              style={{
                background: '#dc3545',
                color: 'white',
                border: 'none',
