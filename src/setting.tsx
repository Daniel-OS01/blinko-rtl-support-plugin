        ...
        <div style={{ marginBottom: '15px', padding: '15px', background: settings.darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(0,0,0,0.03)', borderRadius: '6px' }}>
          ...
          <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap', alignItems: 'center' }}>
            ...
            <button
              ...
              title={!settings.enabled ? "Enable plugin to delete presets" : (!selectedPresetId ? "Select a preset to delete" : (BUILT_IN_PRESETS.some(p => p.id === selectedPresetId) ? "Built-in presets cannot be deleted" : "Delete selected preset"))}
              style={{
                background: '#dc3545',
                color: 'white',
                border: 'none',
