    ...
    <div 
      ...
      <div style={{ 
        ...
        <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap', marginBottom: '15px' }}>
          <button
            onClick={settings.enabled ? processAllContent : undefined}
            aria-disabled={!settings.enabled}
            title={!settings.enabled ? "Enable RTL support to use this action" : "Process all visible content"}
            style={{ 
              background: '#28a745', 
              color: 'white', 
              border: 'none', 
          ...
          <button
            ...
            title="Toggle RTL for current content"
            style={{ 
              background: '#007bff', 
              color: 'white', 
              border: 'none', 
