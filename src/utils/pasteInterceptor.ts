...
export class PasteInterceptor {
  ...
  private showSuggestionToast(text: string, target: HTMLElement) {
    ...
    toast.innerHTML = `
      ...
      <button aria-label="Close suggestion" class="rtl-toast-close" style="position: absolute; top: 5px; right: 5px; border: none; background: transparent; cursor: pointer; font-size: 16px;">&times;</button>
    `;
